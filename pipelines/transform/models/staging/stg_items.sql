...
renamed_and_casted AS (
    SELECT
        ...
        CAST(asset_description__classid AS INT64) AS class_id,
        CAST(asset_description__market_bucket_group_id AS INT64) AS market_bucket_group_id,
        ...
        -- Pricing & Metrics
        CAST(sell_listings AS INT64) AS sell_listings_count,
        CAST(sell_price AS INT64) AS sell_price_cents,
        CAST(sell_price AS NUMERIC) / 100 AS sell_price_usd,
