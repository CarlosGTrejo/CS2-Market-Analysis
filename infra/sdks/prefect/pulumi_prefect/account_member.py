...
class _AccountMemberState:
    def __init__(__self__, *,
        ...
        :param pulumi.Input[_builtins.str] actor_id: Actor ID (UUID)
        :param pulumi.Input[_builtins.str] email: Member email
        :param pulumi.Input[_builtins.str] first_name: Member's first name
        :param pulumi.Input[_builtins.str] handle: Member handle, or a human-readable identifier
        :param pulumi.Input[_builtins.str] last_name: Member's last name
...
@pulumi.type_token("prefect:index/accountMember:AccountMember")
class AccountMember(pulumi.CustomResource):
    ...
    def _internal_init(__self__,
        ...
        if opts.id is None:
            ...
            __props__.__dict__["account_role_id"] = account_role_id
            __props__.__dict__["account_role_name"] = None
        ...
        super(AccountMember, __self__).__init__(
            'prefect:index/accountMember:AccountMember',
            resource_name,
            __props__,
            opts,
    ...
    @_builtins.property
    @pulumi.getter(name="accountRoleId")
    def account_role_id(self) -> pulumi.Output[_builtins.str]:
        """
        Acount Role ID (UUID)
        """
        return pulumi.get(self, "account_role_id")
